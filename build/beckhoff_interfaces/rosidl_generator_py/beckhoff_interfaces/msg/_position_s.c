...
bool beckhoff_interfaces__msg__position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("beckhoff_interfaces.msg._position.Position", full_classname_dest, 42) == 0);
  }
  beckhoff_interfaces__msg__Position * ros_message = _ros_message;
  {  // x
...
PyObject * beckhoff_interfaces__msg__position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("beckhoff_interfaces.msg._position");
