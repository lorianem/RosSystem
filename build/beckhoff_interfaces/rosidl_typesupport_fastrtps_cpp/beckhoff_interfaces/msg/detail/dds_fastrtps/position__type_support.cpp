...
#include "beckhoff_interfaces/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const beckhoff_interfaces::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  beckhoff_interfaces::msg::Position & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = beckhoff_interfaces::msg::Position;
    is_plain =
      (
      offsetof(DataType, r) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const beckhoff_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<beckhoff_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  return &beckhoff_interfaces::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, beckhoff_interfaces, msg, Position)() {
  return &beckhoff_interfaces::msg::typesupport_fastrtps_cpp::_Position__handle;
}
