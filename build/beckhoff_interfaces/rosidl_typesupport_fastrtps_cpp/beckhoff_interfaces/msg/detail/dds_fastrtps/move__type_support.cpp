...
#include "beckhoff_interfaces/msg/detail/move__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = beckhoff_interfaces::msg::Move;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const beckhoff_interfaces::msg::Move *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<beckhoff_interfaces::msg::Move *>(
    untyped_ros_message);
...
{
  return &beckhoff_interfaces::msg::typesupport_fastrtps_cpp::_Move__handle;
}
