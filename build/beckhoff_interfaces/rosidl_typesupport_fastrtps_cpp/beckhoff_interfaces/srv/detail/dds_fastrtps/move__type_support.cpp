...
#include "beckhoff_interfaces/srv/detail/move__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const beckhoff_interfaces::srv::Move_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  beckhoff_interfaces::srv::Move_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = beckhoff_interfaces::srv::Move_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const beckhoff_interfaces::srv::Move_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<beckhoff_interfaces::srv::Move_Request *>(
    untyped_ros_message);
...
{
  return &beckhoff_interfaces::srv::typesupport_fastrtps_cpp::_Move_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, beckhoff_interfaces, srv, Move_Request)() {
  return &beckhoff_interfaces::srv::typesupport_fastrtps_cpp::_Move_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_beckhoff_interfaces
cdr_serialize(
  const beckhoff_interfaces::srv::Move_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: err
  cdr << ros_message.err;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  beckhoff_interfaces::srv::Move_Response & ros_message)
{
  // Member: err
  cdr >> ros_message.err;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = beckhoff_interfaces::srv::Move_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const beckhoff_interfaces::srv::Move_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<beckhoff_interfaces::srv::Move_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &beckhoff_interfaces::srv::typesupport_fastrtps_cpp::_Move_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, beckhoff_interfaces, srv, Move_Response)() {
  return &beckhoff_interfaces::srv::typesupport_fastrtps_cpp::_Move_Response__handle;
}
...
{
  return &beckhoff_interfaces::srv::typesupport_fastrtps_cpp::_Move__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, beckhoff_interfaces, srv, Move)() {
  return &beckhoff_interfaces::srv::typesupport_fastrtps_cpp::_Move__handle;
}
