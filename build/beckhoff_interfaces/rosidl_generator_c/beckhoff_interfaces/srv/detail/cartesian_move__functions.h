...
#ifndef BECKHOFF_INTERFACES__SRV__DETAIL__CARTESIAN_MOVE__FUNCTIONS_H_
#define BECKHOFF_INTERFACES__SRV__DETAIL__CARTESIAN_MOVE__FUNCTIONS_H_
...
/// Initialize srv/CartesianMove message.
/**
...
/// Finalize srv/CartesianMove message.
/**
...
/// Create srv/CartesianMove message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * beckhoff_interfaces__srv__CartesianMove_Request__init().
...
/// Destroy srv/CartesianMove message.
/**
 * It calls
 * beckhoff_interfaces__srv__CartesianMove_Request__fini()
...
/// Check for srv/CartesianMove message equality.
/**
...
/// Copy a srv/CartesianMove message.
/**
...
/// Initialize array of srv/CartesianMove messages.
/**
...
/// Finalize array of srv/CartesianMove messages.
/**
 * It calls
 * beckhoff_interfaces__srv__CartesianMove_Request__fini()
...
/// Create array of srv/CartesianMove messages.
/**
 * It allocates the memory for the array and calls
 * beckhoff_interfaces__srv__CartesianMove_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CartesianMove messages.
/**
 * It calls
 * beckhoff_interfaces__srv__CartesianMove_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CartesianMove message array equality.
/**
...
/// Copy an array of srv/CartesianMove messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * beckhoff_interfaces__srv__CartesianMove_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_beckhoff_interfaces
...
/**
 * It calls
 * beckhoff_interfaces__srv__CartesianMove_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_beckhoff_interfaces
...
/**
 * It allocates the memory for the array and calls
 * beckhoff_interfaces__srv__CartesianMove_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_beckhoff_interfaces
...
/**
 * It calls
 * beckhoff_interfaces__srv__CartesianMove_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BECKHOFF_INTERFACES__SRV__DETAIL__CARTESIAN_MOVE__FUNCTIONS_H_
