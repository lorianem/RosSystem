...
class Metaclass_Gripper(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'beckhoff_interfaces.srv.Gripper')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from beckhoff_interfaces.srv import _gripper
...
class Gripper(metaclass=Metaclass_Gripper):
    from beckhoff_interfaces.srv._gripper import Gripper_Request as Request
    from beckhoff_interfaces.srv._gripper import Gripper_Response as Response
